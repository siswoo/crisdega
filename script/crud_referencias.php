...
if ($condicion == 'table1') {
    ...
    // Valida y ajusta los valores de página y consultas por página si es necesario
    if ($pagina == 0 || $pagina == '') {
        $pagina = 1;
    }

    if ($consultasporpagina == 0 || $consultasporpagina == '') {
        $consultasporpagina = 10;
    }

    // Construye las cláusulas WHERE según los filtros ingresados
    if ($filtrado != '') {
    ...
    // Consulta base para obtener el conteo total de registros
    ...
    // Consulta paginada para obtener los registros de la página actual
    ...
    // Construye el HTML para mostrar los resultados en la tabla
    $html = '';
    ...
    // Comprueba si hay resultados y los agrega al HTML
    if ($conteo1 >= 1) {
